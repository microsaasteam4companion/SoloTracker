...
const AuthFlow: React.FC<AuthFlowProps> = ({ onBack, onSuccess }) => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Handle manual redirect if necessary (some browsers/environments)
      if (data?.url) {
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-[10px] uppercase font-black">
                    <span className="bg-white dark:bg-slate-950 px-4 text-slate-400 dark:text-slate-600">Or use email</span>
                  </div>
                </div>
